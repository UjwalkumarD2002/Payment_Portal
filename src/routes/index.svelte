...
<SvelteSeo
	title='SplitPay | home'
	description='split your bills easily! SplitPay is an open-source webapp built for tracking debts and payments quickly, without any user accounts.'
	openGraph={{
		title: 'SplitPay | split your bills easily!',
		description: 'SplitPay is an open-source webapp built for tracking debts and payments quickly, without any user accounts.',
